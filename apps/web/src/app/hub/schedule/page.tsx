      ...
      <section className="px-[--spacing-container] pb-24 space-y-3">
        {isLoading ? (
          ...
          slots.map((slot: any) => {
            ...
            return (
              <div key={slot.id} className="bg-surface-container-lowest rounded-xl p-4 shadow-sm flex items-center gap-4">
                <div className="w-14 h-14 rounded-xl bg-primary/10 flex flex-col items-center justify-center shrink-0">
                  <span className="text-xs font-bold text-primary">{SHORT_DAYS[date.getDay()]}</span>
